...
- Owns AMSY tenant frontend UI, routing, branding, and tenant-specific client behavior.
...
- Add `CONTEXT.md` for AMSY-specific domain terms when the project needs local vocabulary.
